...
Inside your project, you can then run the following command, which is similar to `bun add hono-ronin` or `npm install hono-ronin`, except that it doesn't install `ronin` from npm, but instead uses your local clone of the package:
